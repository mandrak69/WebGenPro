...
public class User {
    ...
    public User(String name, String last_name, String phone, String email, String address, String username, String password, int grad_id, int nivokorisnika_id) {
        this.name = name;
    ...
    public User(String name, String last_name, String email, String address, String username, String password, int grad_id, int nivokorisnika_id) {
        this.name = name;
        this.last_name = last_name;
        this.email = email;
        this.address = address;
    ...
    public User(String name, String last_name, String username, String password, int grad_id, int nivokorisnika_id) {
        this.name = name;
        this.last_name = last_name;
        this.username = username;
        this.password = password;
    ...
    public User(Integer id, String name, String last_name, String phone, String email, String address, String username, String password, int grad_id, int nivokorisnika_id) {
        this.id = id;
        this.name = name;
        this.last_name = last_name;
        this.phone = phone;
    ...
    public String toString() {
        return "User{" + "id=" + id + ", name=" + name + ", last_name=" + last_name + ", phone=" + phone + ", email=" + email + ", address=" + address + ", username=" + username + ", password=" + password + ", grad_id=" + grad_id + ", nivokorisnika_id=" + nivokorisnika_id + '}';
    }
